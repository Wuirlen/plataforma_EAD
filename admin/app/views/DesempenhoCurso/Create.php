...
<input style="display: none;" id="nome_curso_input" type="text" value="<?php echo $desempenho_curso->nome_curso; ?>">
  ...
  <div class="base-lista">
    ...
    <!--  <button style="float: right;" class="btn d-inline-block mx-1" id="btnExport" > Gerar excel </button> -->
    </div>
      <?php
      $this->verMsg();
      ?>
        <table data-page-length='5' cellpadding="0" cellspacing="0" border="0" id="dataTable" class="noExl">
          <thead>
            <tr>
...
<script>
      $(function() {
        $("#btnExport").click(function() {
          var _text = $('#nome_curso_input').val();
          console.log(_text);
          $("#dataTable").table2excel({
            filename: "Desempenho_Curso-" +_text+ ".xls",
            name: "Worksheet Name",
          });
        })
      });
