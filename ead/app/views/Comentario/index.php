<div class="caixa">
    <h2 class="titulo"><span class="case"><i class="ico duvida"></i>Comentários</span> Perguntas e resposta da
    plataforma</h2>
</div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="resposta">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras tellus ante, iaculis sed nulla
                            consequat, interdum posuere arcu. Suspendisse pellentesque, augue vitae cursus cursus,
                            tellus purus hendrerit elit, quis malesuada est nunc ac diam. </p>
                    </div>
                </li>
            </ul>
        </div>
