            ...
            <div class="base-caixa-curso rows">
                ...
                <div class="col-8">
                    ...
                    <ul>
                        ...
                        <li><i class="ico hora"></i><small>Duração:</small> <span><?php echo $curso->duracao_curso ?></span></li>
                    ...
                    <div class="progress">
                        <small>Nível de progressão deste curso <b>
                                ...
                                echo $progressao;
                                ?>%</b></small>
                        <progress value="<?php echo $qtde_assistidas->qtde ?>" max="<?php echo $qtde_aula ?>"></progress>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <li class="section">
                            <?php if ($modulos->id_modulo == $modulo[$cont]->id_modulo) {  ?>
                                ...
                                <ul>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <?php if ($aulas["id_modulo"]  == $modulo[$cont]->id_modulo) { ?>
                                                    ...
                                                    <tr>
                                                        <td align="left"><a href="<?php echo URL_BASE . "aula/assistir/" . $aulas["id_aula"] ?>"><i class="ico ititulo"></i>
                                                                <?php echo $aulas["titulo_aula"] ?></a></td>
                                                        <td align="left"><i class="ico iduracao"></i><?php echo $aulas["duracao_aula"] ?></td>
                                                        <td align="left"><i class="ico idata"></i><?php echo $aulas["data_assistida"] ?></td>
                                                        <td align="left"><i class="ico <?php echo $assistido ?>"></i><?php echo $afirmacao ?></td>
                                                    </tr>
                                                <?php } ?>
                                    ...
                                    <?php  for ($i = 0; $i < count($qtd_aula_por_modulo); $i++) {  ?>
                                        <?php for ($j = 0; $j < count($qtd_aulas_assistidas_por_modulo); $j++) {  ?>
                                            <?php if ($modulos->id_modulo == $qtd_aulas_assistidas_por_modulo[$j][0]->id_modulo) {  ?>
                                                <?php if ($qtd_aulas_assistidas_por_modulo[$j][0]->qtd_aula_assistida_por_modulo != 0 && $qtd_aula_por_modulo[$i][0]->qtd_aula != 0) {    ?>
                                                    <?php if ($qtd_aulas_assistidas_por_modulo[$j][0]->id_modulo == $qtd_aula_por_modulo[$i][0]->id_modulo) { ?>
                                                        <?php $porcentahem = $qtd_aulas_assistidas_por_modulo[$j][0]->qtd_aula_assistida_por_modulo * 100 / $qtd_aula_por_modulo[$i][0]->qtd_aula;  ?>
                                                        <?php if ($porcentahem == 100) {  ?>
                                                            <?php if (count($avaliacao_aluno[$i]) != 0 ) {  ?>
                                                                <?php if ($avaliacao_aluno[$i][0]->id_modulo == $qtd_aula_por_modulo[$i][0]->id_modulo) { ?>
                                                                ...
                                                                <?php  } else {   ?>
                                                                    <div class="col-4 mb-3" style="padding: 2px;top: 10px;">
                                                                        <span class="titulo">Prova Avaliativa</span>
                                                                        <a class="button" href="http://localhost/projetos-tutiplast/quiz/" onclick='modulo("<?php echo $modulos->id_modulo ?>","<?php echo $id_aluno ?>","<?php echo $voltar ?>")'><?php echo $modulos->titulo_avaliacao ?></a>
                                                                    </div>
                                                                <?php  } ?>
                                                            <?php  } else {  ?>
                                                                <?php   if(count($avaliacao[$i]) != 0){  ?>
                                                                <div class="col-4 mb-3" style="padding: 2px;top: 10px;">
                                                                    <span class="titulo">Prova Avaliativa</span>
                                                                    <a class="button" href="http://localhost/projetos-tutiplast/quiz/" onclick='modulo("<?php echo $modulos->id_modulo ?>","<?php echo $id_aluno ?>","<?php echo $voltar ?>")'><?php echo $modulos->titulo_avaliacao ?></a>
                                                                </div>
            ...
            <div class="caixa">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        ?>
                            <?php  if (($valida_certificado_fez_prova->qtd_acertada * 100) / $qtd_questao_por_curso_avaliacao->qtd_questao_curso >= 70) { ?>
                                ...
                                <span style="cursor:pointer;color:#d43d3d" onclick="gerar(<?php echo $voltar ?>,0,<?php echo $this->id_aluno ?>,'<?php echo $autenticacao ?>')" class="tt2">Gerar</span>
                            <?php } ?>
                        <?php } else { ?>
                            <?php $soma_qtd_aulas = 0;
                            ...
                            ?>
                             <?php  if(count($baixar_certificado)==0){?>
                                <i class="ico certificado"></i>
                                <span class="tt1">Certificado Por Participação</span>
                                <span style="cursor:pointer;color:#d43d3d" onclick="gerar(<?php echo $voltar ?>,1)" class="tt2">Gerar</span>
                                <?php }else{  ?>
                                    <i class="ico certificado"></i>
                                <span class="tt1">Certificado Por Participação</span><a style=" text-decoration:none; " href="<?php echo URL_IMAGEM . $baixar_certificado[0]->path_certificado ?>" class="icon" target="_blank" download>
